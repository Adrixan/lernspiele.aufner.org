...
function glitchText(text, intensity) {
    ...
    return text
        .split('')
        .map((ch) => Math.random() < intensity && ch !== ' '
 ...
 */
export function FloorAnnouncementOverlay({ floorNumber, floorName, subtitle, isVisible, onDismiss, }) {
    ...
    return (_jsxs("div", { style: backdropStyle, role: "alert", "aria-live": "assertive", children: [_jsx("div", { style: scanlineStyle, "aria-hidden": "true" }), _jsx("div", { style: floorNumberStyle, "aria-hidden": "true", children: `[ FLOOR ${floorNumber} ]` }), _jsx("div", { style: titleStyle, children: displayedTitle }), _jsx("div", { style: dividerStyle, "aria-hidden": "true" }), _jsx("div", { style: subtitleStyle, children: subtitle })] }));
}
//# sourceMappingURL=FloorAnnouncementOverlay.js.map