 ...
 */
export function CRTEffect({ children, enabled = true, trackingNoise = false, }) {
    return (_jsxs(_Fragment, { children: [_jsx("style", { children: CRT_STYLES }), _jsxs("div", { className: enabled ? 'crt-root' : 'crt-root-plain', children: [children, enabled && (_jsxs(_Fragment, { children: [_jsx("div", { className: "crt-scanlines", "aria-hidden": "true" }), _jsx("div", { className: "crt-vignette", "aria-hidden": "true" }), trackingNoise && _jsx("div", { className: "crt-noise", "aria-hidden": "true" })] }))] })] }));
}
// ---------------------------------------------------------------------------
