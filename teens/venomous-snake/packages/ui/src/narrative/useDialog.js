...
export function useDialog(options = {}) {
    ...
    const selectChoice = useCallback((index) => {
        const engine = engineRef.current;
        if (!engine)
            return;
        try {
