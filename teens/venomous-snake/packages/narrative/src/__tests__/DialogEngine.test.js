...
describe('DialogEngine', () => {
    ...
    it('navigates to the correct branch when a choice is selected', () => {
        ...
        const nodeDisplayEvents = events.filter((e) => e.type === 'node_display');
    ...
    it('hides conditional choices when the required flag is not set', () => {
        ...
        const choicesEvent = events.find((e) => e.type === 'choices_available');
...
//# sourceMappingURL=DialogEngine.test.js.map