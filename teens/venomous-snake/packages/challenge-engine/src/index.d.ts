...
export { floorConfigs, getFloorConfig, getChallengesForFloor, isFloorComplete, getNextUnlockedFloor, getFloorProgress, getFloorNumberFromId, getFloorIdFromNumber, } from './FloorChallengeMap';
