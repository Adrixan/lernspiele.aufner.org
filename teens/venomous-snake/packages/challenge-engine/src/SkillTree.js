...
export class SkillTreeManager {
    ...
    canUnlock(skillId, completedChallenges, xp) {
        ...
        if (!prereqsMet)
            return false;
        const challengesMet = node.requiredChallenges.every((challengeId) => completedChallenges.includes(challengeId));
        if (!challengesMet)
            return false;
    ...
    getAvailableSkills(completedChallenges, xp) {
