export const ch09_03_lambda_functions = {
    ...
    hints: [
        { tier: 1, text: 'lambda x: x[1] creates a function that returns the second element of a tuple.' },
        { tier: 2, text: 'sorted() with key= uses the lambda to determine sort order. reverse=True sorts descending.' },
        { tier: 3, text: 'Solution: sorted(agents, key=lambda x: x[1], reverse=True)' },
    ],
...
//# sourceMappingURL=ch09_03_lambda_functions.js.map