export const ch09_10_combining_tools = {
    ...
    hints: [
        { tier: 1, text: 'Use filter() to keep scores >= 50, sorted() to sort descending, map() to double.' },
        { tier: 2, text: 'Chain: sorted(filter(...), reverse=True), then sum(map(...)).' },
        { tier: 3, text: 'Solution: result = sorted(filter(lambda x: x >= 50, raw_scores), reverse=True)' },
    ],
...
//# sourceMappingURL=ch09_10_combining_tools.js.map