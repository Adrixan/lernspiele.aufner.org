export const ch09_07_dictionary_comprehension = {
    ...
    hints: [
        { tier: 1, text: 'Dictionary comprehensions use {key: value for item in iterable}.' },
        { tier: 2, text: 'Use agent as key and len(agent) * 10 as value.' },
        { tier: 3, text: 'Solution: {agent: len(agent) * 10 for agent in agents}' },
    ],
...
//# sourceMappingURL=ch09_07_dictionary_comprehension.js.map