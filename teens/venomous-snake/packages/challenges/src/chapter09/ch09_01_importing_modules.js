export const ch09_01_importing_modules = {
    ...
    hints: [
        { tier: 1, text: 'math.sqrt() returns the square root. math.floor() rounds down. random.randint() returns a random integer.' },
        { tier: 2, text: 'Import the module first with import math, then call math.sqrt(144).' },
        { tier: 3, text: 'Solution: math.sqrt(144), math.floor(9.7), random.randint(1, 10)' },
    ],
...
//# sourceMappingURL=ch09_01_importing_modules.js.map