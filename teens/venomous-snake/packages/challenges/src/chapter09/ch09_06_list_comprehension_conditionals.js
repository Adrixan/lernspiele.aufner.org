export const ch09_06_list_comprehension_conditionals = {
    ...
    hints: [
        { tier: 1, text: 'Use the modulo operator % to check divisibility. x % 2 == 0 means even.' },
        { tier: 2, text: 'Combine conditions with and: x % 2 == 0 and x % 3 == 0.' },
        { tier: 3, text: 'Solution: [x for x in data if x % 2 == 0 and x % 3 == 0]' },
    ],
...
//# sourceMappingURL=ch09_06_list_comprehension_conditionals.js.map