export const ch09_02_from_import = {
    ...
    scaffoldedCode: 'from math import ___, ___, ___\nprint(round(___, 4))\nprint(___(7.2))\nprint(___(7.8))',
    editableRegions: [
        { startLine: 1, endLine: 1, placeholder: 'pi, ceil, floor' },
    ],
    solutionCode: 'from math import pi, ceil, floor\nprint(round(pi, 4))\nprint(ceil(7.2))\nprint(floor(7.8))',
    testCases: [
        {
            id: 'tc01',
    ...
    hints: [
        { tier: 1, text: 'from math import pi, ceil, floor imports specific names directly.' },
        { tier: 2, text: 'After from-import, use the names directly: pi, ceil(7.2), floor(7.8).' },
        { tier: 3, text: 'Solution: from math import pi, ceil, floor' },
    ],
...
//# sourceMappingURL=ch09_02_from_import.js.map