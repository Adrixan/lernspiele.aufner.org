export const ch09_05_filter_function = {
    ...
    hints: [
        { tier: 1, text: 'filter(function, iterable) keeps only elements where the function returns True.' },
        { tier: 2, text: 'Use lambda x: x > 10 to keep values greater than 10.' },
        { tier: 3, text: 'Solution: list(filter(lambda x: x > 10, signals))' },
    ],
...
//# sourceMappingURL=ch09_05_filter_function.js.map