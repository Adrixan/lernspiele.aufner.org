export const ch09_04_map_function = {
    ...
    hints: [
        { tier: 1, text: 'map(function, iterable) applies the function to each element.' },
        { tier: 2, text: 'Use lambda x: x * 7 + 3 as the transformation function.' },
        { tier: 3, text: 'Solution: list(map(lambda x: x * 7 + 3, codes))' },
    ],
...
//# sourceMappingURL=ch09_04_map_function.js.map