export const ch09_08_string_formatting_advanced = {
    ...
    hints: [
        { tier: 1, text: 'Use :<10 for left-align in 10 chars, :>5 for right-align in 5 chars.' },
        { tier: 2, text: 'Store header strings in variables, then use format specs: f"{header_name:<10}".' },
        { tier: 3, text: 'Solution: f"{header_name:<10} {header_level:>5} {header_xp:>8}" and f"{name:<10} {level:>5} {xp:>8}"' },
    ],
...
//# sourceMappingURL=ch09_08_string_formatting_advanced.js.map