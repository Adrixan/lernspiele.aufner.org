export const ch02_07_string_formatting = {
    ...
    scaffoldedCode: '# Build a mission status report using f-strings\noperative = "Vex"\nmission = "Operation Blackout"\nstatus = "ACTIVE"\nfloor = 3\nreport = ___\nprint(report)',
    editableRegions: [
        {
            startLine: 6,
            endLine: 6,
...
//# sourceMappingURL=ch02_07_string_formatting.js.map