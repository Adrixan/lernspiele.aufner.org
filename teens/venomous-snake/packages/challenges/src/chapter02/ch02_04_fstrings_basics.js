export const ch02_04_fstrings_basics = {
    ...
    scaffoldedCode: '# Create an ID card using f-strings\nname = "Aleksa"\nrank = "Field Operative"\nclearance = 4\nid_card = ___\nprint(id_card)',
    editableRegions: [
        {
            startLine: 5,
            endLine: 5,
...
//# sourceMappingURL=ch02_04_fstrings_basics.js.map