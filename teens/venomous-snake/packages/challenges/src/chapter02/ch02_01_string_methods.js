export const ch02_01_string_methods = {
    ...
    scaffoldedCode: '# Transform the codename using string methods\ncodename = "shadow viper"\n# Use .upper(), .lower(), and .title() methods\nprint(___)\nprint(___)\nprint(___)',
    editableRegions: [
...
//# sourceMappingURL=ch02_01_string_methods.js.map