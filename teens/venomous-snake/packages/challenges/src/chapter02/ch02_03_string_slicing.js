export const ch02_03_string_slicing = {
    ...
    scaffoldedCode: '# Slice the intercepted message to extract parts\nmessage = "CLASSIFIED_INTEL"\nprefix = ___\nsuffix = ___\nsegment = ___\nprint(prefix)\nprint(suffix)\nprint(segment)',
    editableRegions: [
    ...
    solutionCode: 'message = "CLASSIFIED_INTEL"\nprefix = message[:10]\nsuffix = message[11:]\nsegment = message[3:8]\nprint(prefix)\nprint(suffix)\nprint(segment)',
    testCases: [
        {
            id: 'tc01',
...
//# sourceMappingURL=ch02_03_string_slicing.js.map