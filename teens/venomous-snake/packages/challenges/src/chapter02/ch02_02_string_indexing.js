export const ch02_02_string_indexing = {
    ...
    scaffoldedCode: '# Extract specific characters from the access code\naccess_code = "VIPER7"\nfirst = ___\nlast = ___\nthird = ___\nprint(first)\nprint(last)\nprint(third)',
    editableRegions: [
    ...
    solutionCode: 'access_code = "VIPER7"\nfirst = access_code[0]\nlast = access_code[-1]\nthird = access_code[2]\nprint(first)\nprint(last)\nprint(third)',
    testCases: [
        {
            id: 'tc01',
...
//# sourceMappingURL=ch02_02_string_indexing.js.map