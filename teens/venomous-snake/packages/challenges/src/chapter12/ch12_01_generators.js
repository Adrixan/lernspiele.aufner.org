export const ch12_01_generators = {
    ...
    scaffoldedCode: 'def signal_generator(start, count):\n    for i in range(count):\n        ___ start + i * 7\n\ngen = signal_generator(100, 5)\nfor signal in gen:\n    print(signal)',
    editableRegions: [
        { startLine: 3, endLine: 3, placeholder: 'yield' },
    ],
    solutionCode: 'def signal_generator(start, count):\n    for i in range(count):\n        yield start + i * 7\n\ngen = signal_generator(100, 5)\nfor signal in gen:\n    print(signal)',
    testCases: [
        {
            id: 'tc01',
    ...
    hints: [
        { tier: 1, text: 'yield pauses the function and returns a value. The function resumes on next iteration.' },
        { tier: 2, text: 'Replace return with yield to make a function into a generator.' },
        { tier: 3, text: 'Solution: yield start + i * 7' },
    ],
...
//# sourceMappingURL=ch12_01_generators.js.map