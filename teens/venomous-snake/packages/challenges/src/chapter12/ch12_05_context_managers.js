export const ch12_05_context_managers = {
    ...
    hints: [
        { tier: 1, text: 'try/finally guarantees cleanup code runs even if an error occurs in the try block.' },
        { tier: 2, text: 'Put resource usage (open, transmit) in try. Put cleanup (close) in finally.' },
        { tier: 3, text: 'Solution: try: ch.open() + ch.transmit(...), finally: ch.close()' },
    ],
...
//# sourceMappingURL=ch12_05_context_managers.js.map