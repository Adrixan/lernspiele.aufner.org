export const ch12_08_walrus_operator = {
    ...
    hints: [
        { tier: 1, text: 'Use startswith() to check if a log line begins with "ERROR".' },
        { tier: 2, text: 'Split the line on ":" to get the error prefix, then split on " " to extract the error code.' },
        { tier: 3, text: 'Solution: log.startswith("ERROR"), split(":")[0].split(" ")[1] gets the code, "ERROR " + code.' },
    ],
...
//# sourceMappingURL=ch12_08_walrus_operator.js.map