export const ch12_09_advanced_comprehensions = {
    ...
    scaffoldedCode: '# Flatten a matrix keeping only odd numbers using nested loops\n# Create floor-room pairs from a nested dictionary using nested loops\n',
    ...
    hints: [
        { tier: 1, text: 'Nested for loops: the outer loop iterates rows, the inner loop iterates elements.' },
        { tier: 2, text: 'For dict iteration: for floor, rooms in floors.items(): then for room in rooms:' },
        { tier: 3, text: 'Solution: nested for loops with append for both flattening and pair creation' },
    ],
...
//# sourceMappingURL=ch12_09_advanced_comprehensions.js.map