export const ch12_04_decorators_with_args = {
    ...
    hints: [
        { tier: 1, text: 'A parameterized decorator is a function that returns a decorator. Three nested functions.' },
        { tier: 2, text: 'min_level is captured from the outer function via closure.' },
        { tier: 3, text: 'Solution: if agent_level < min_level and f"Need level {min_level}"' },
    ],
...
//# sourceMappingURL=ch12_04_decorators_with_args.js.map