export const ch12_06_async_basics = {
    ...
    solutionCode: 'def fetch_intel(target, callback):\n    result = f"Intel on {target}: 42 vulnerabilities found"\n    callback(result)\n\ndef process_result(result):\n    print(result)\n\nfetch_intel("NexusCorp", process_result)\n\ntargets = ["VaultX", "ShadowNet"]\nresults = []\nfor t in targets:\n    results.append(f"Intel on {t}: 42 vulnerabilities found")\nfor r in results:\n    print(r)',
    testCases: [
        {
            id: 'tc01',
    ...
    hints: [
        { tier: 1, text: 'Callbacks are functions passed as arguments. The receiving function calls them when work is done.' },
        { tier: 2, text: 'Pass process_result as the callback to fetch_intel. It will be called with the result.' },
        { tier: 3, text: 'Solution: fetch_intel(target, callback) calls callback(result). Pass process_result as the callback.' },
    ],
...
//# sourceMappingURL=ch12_06_async_basics.js.map