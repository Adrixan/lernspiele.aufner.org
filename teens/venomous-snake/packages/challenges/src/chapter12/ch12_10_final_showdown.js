export const ch12_10_final_showdown = {
    ...
    hints: [
        { tier: 1, text: 'Use startswith() and string index/slice to parse log entries. Use a class for structured data.' },
        { tier: 2, text: 'Filter with list comprehension, sort with sorted() and a lambda key.' },
        { tier: 3, text: 'Solution: check startswith("VULN-"), use index("["), index("]"), index(": ") to extract fields.' },
    ],
...
//# sourceMappingURL=ch12_10_final_showdown.js.map