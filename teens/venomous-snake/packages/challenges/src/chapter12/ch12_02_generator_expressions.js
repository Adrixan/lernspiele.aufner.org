export const ch12_02_generator_expressions = {
    ...
    hints: [
        { tier: 1, text: 'Generator functions use yield instead of return. They produce values one at a time.' },
        { tier: 2, text: 'yield x ** 2 produces the squared value. Use list() to collect all yielded values.' },
        { tier: 3, text: 'Solution: yield x ** 2 in both generator functions' },
    ],
...
//# sourceMappingURL=ch12_02_generator_expressions.js.map