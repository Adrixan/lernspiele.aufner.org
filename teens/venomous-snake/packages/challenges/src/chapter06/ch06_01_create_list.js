export const ch06_01_create_list = {
    ...
    xpReward: 125,
    tags: ['list', 'indexing'],
    scaffoldedCode: '# Create a list of hacking tools and access each one\ntools = [___, ___, ___]\nprint(tools[0])\nprint(tools[1])\nprint(tools[2])',
    editableRegions: [
        { startLine: 2, endLine: 2, placeholder: '"keylogger", "port_scanner", "exploit_kit"' },
    ],
    solutionCode: 'tools = ["keylogger", "port_scanner", "exploit_kit"]\nprint(tools[0])\nprint(tools[1])\nprint(tools[2])',
    testCases: [
        {
            id: 'tc01',
...
//# sourceMappingURL=ch06_01_create_list.js.map