export const ch01_08_comments = {
    ...
    scaffoldedCode: '# Add a comment above each line of code explaining what it does\n___\nclearance_level = 5\n___\ndepartment = "Infiltration"\n___\nprint("Clearance:", clearance_level, "| Dept:", department)',
    editableRegions: [
    ...
    solutionCode: '# Store the operative\'s clearance level\nclearance_level = 5\n# Store the operative\'s department\ndepartment = "Infiltration"\n# Print a status report\nprint("Clearance:", clearance_level, "| Dept:", department)',
    testCases: [
        {
            id: 'tc01',
...
//# sourceMappingURL=ch01_08_comments.js.map