export const ch01_06_string_concatenation = {
    ...
    scaffoldedCode: '# Build a full name from separate parts\nfirst_name = "Aleksa"\nlast_name = "Volkov"\nfull_name = ___\nprint(full_name)',
    editableRegions: [{ startLine: 4, endLine: 4, placeholder: 'first_name + " " + last_name' }],
    solutionCode: 'first_name = "Aleksa"\nlast_name = "Volkov"\nfull_name = first_name + " " + last_name\nprint(full_name)',
    testCases: [
        {
            id: 'tc01',
...
//# sourceMappingURL=ch01_06_string_concatenation.js.map