export const ch07_08_data_transformation = {
    ...
    hints: [
        { tier: 1, text: 'Parse the JSON string first, then access the "targets" key.' },
        { tier: 2, text: 'Use a list comprehension with .upper() to transform each target.' },
        { tier: 3, text: 'Solution: data = json.loads(raw), targets = data["targets"], result = [t.upper() for t in targets]' },
    ],
...
//# sourceMappingURL=ch07_08_data_transformation.js.map