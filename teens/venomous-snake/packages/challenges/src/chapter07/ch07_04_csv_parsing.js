export const ch07_04_csv_parsing = {
    ...
    scaffoldedCode: 'csv_data = "snake,viper,cobra,python"\nfields = csv_data.___(___)\nfor field in fields:\n    print(field)',
    editableRegions: [
        { startLine: 2, endLine: 2, placeholder: 'split(",")' },
    ],
    solutionCode: 'csv_data = "snake,viper,cobra,python"\nfields = csv_data.split(",")\nfor field in fields:\n    print(field)',
    testCases: [
        {
            id: 'tc01',
    ...
    hints: [
        { tier: 1, text: 'The .split() method breaks a string into a list using a delimiter.' },
        { tier: 2, text: 'Use .split(",") to split on commas.' },
        { tier: 3, text: 'Solution: fields = csv_data.split(",")' },
    ],
...
//# sourceMappingURL=ch07_04_csv_parsing.js.map