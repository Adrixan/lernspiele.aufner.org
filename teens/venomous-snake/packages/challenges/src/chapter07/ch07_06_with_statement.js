export const ch07_06_with_statement = {
    ...
    scaffoldedCode: 'data = "Secure transmission received\\nDecrypting payload..."\nlines = data.split("\\n")\ntry:\n    for line in ___:\n        print(___)\nfinally:\n    print("Channel closed")',
    editableRegions: [
        { startLine: 4, endLine: 4, placeholder: 'lines' },
        { startLine: 5, endLine: 5, placeholder: 'line' },
    ],
    solutionCode: 'data = "Secure transmission received\\nDecrypting payload..."\nlines = data.split("\\n")\ntry:\n    for line in lines:\n        print(line)\nfinally:\n    print("Channel closed")',
    testCases: [
        {
            id: 'tc01',
    ...
    hints: [
        { tier: 1, text: 'try/finally ensures cleanup code runs even if an error occurs. Put resource usage in try, cleanup in finally.' },
        { tier: 2, text: 'Use split("\\n") to break a string into lines. Loop with for line in lines.' },
        { tier: 3, text: 'Solution: lines = data.split("\\n"), try/finally loop, print "Channel closed" in finally.' },
    ],
...
//# sourceMappingURL=ch07_06_with_statement.js.map