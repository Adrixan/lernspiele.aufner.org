export const ch07_02_write_file = {
    ...
    hints: [
        { tier: 1, text: 'io.StringIO() creates an empty file-like object you can write to.' },
        { tier: 2, text: 'Use f.write("text") to write strings. f.getvalue() returns all written content.' },
        { tier: 3, text: 'Solution: f.write("Mission log: Entry 1\\n") and f.write("Infiltrated sector 7\\n")' },
    ],
...
//# sourceMappingURL=ch07_02_write_file.js.map