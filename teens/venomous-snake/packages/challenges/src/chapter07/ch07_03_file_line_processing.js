export const ch07_03_file_line_processing = {
    ...
    hints: [
        { tier: 1, text: 'Use .strip() to remove leading and trailing whitespace from each line.' },
        { tier: 2, text: 'The if condition should filter out lines that are empty after stripping.' },
        { tier: 3, text: 'Solution: [line.strip() for line in f.readlines() if line.strip()]' },
    ],
...
//# sourceMappingURL=ch07_03_file_line_processing.js.map