export const ch07_01_read_file = {
    ...
    hints: [
        { tier: 1, text: 'io.StringIO creates a file-like object from a string. Pass the data variable to it.' },
        { tier: 2, text: 'Use f.read() to read the entire content of the file-like object.' },
        { tier: 3, text: 'Solution: f = io.StringIO(file_data) and content = f.read()' },
    ],
...
//# sourceMappingURL=ch07_01_read_file.js.map