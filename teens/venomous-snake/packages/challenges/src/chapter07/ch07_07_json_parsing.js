export const ch07_07_json_parsing = {
    ...
    hints: [
        { tier: 1, text: 'json.loads() parses a JSON string into a Python dictionary.' },
        { tier: 2, text: 'Access dictionary values with data["key"]. JSON true becomes Python True.' },
        { tier: 3, text: 'Solution: data = json.loads(json_str), then print(data["agent"]) etc.' },
    ],
...
//# sourceMappingURL=ch07_07_json_parsing.js.map