export const ch07_05_string_split_join = {
    ...
    scaffoldedCode: 'message = "ALPHA:BRAVO:CHARLIE:DELTA"\nparts = message.split(___)\nprint(parts)\nresult = ___.join(parts)\nprint(result)',
    solutionCode: 'message = "ALPHA:BRAVO:CHARLIE:DELTA"\nparts = message.split(":")\nprint(parts)\nresult = " | ".join(parts)\nprint(result)',
    testCases: [
        {
            id: 'tc01',
    ...
    hints: [
        { tier: 1, text: 'Use .split(":") to split on colons, and " | ".join() to rejoin with pipes.' },
        { tier: 2, text: 'The .join() method is called on the separator string: separator.join(list).' },
        { tier: 3, text: 'Solution: parts = message.split(":") and result = " | ".join(parts)' },
    ],
...
//# sourceMappingURL=ch07_05_string_split_join.js.map