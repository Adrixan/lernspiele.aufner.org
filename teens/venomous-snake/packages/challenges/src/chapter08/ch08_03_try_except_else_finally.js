export const ch08_03_try_except_else_finally = {
    ...
    scaffoldedCode: 'def decode_signal(code):\n    try:\n        result = int(code) * 2\n    except ___:\n        print("ERROR: Invalid signal")\n    ___:\n        print(f"Signal decoded: {result}")\n    ___:\n        print("Transmission complete")\n\ndecode_signal("21")',
    solutionCode: 'def decode_signal(code):\n    try:\n        result = int(code) * 2\n    except ValueError:\n        print("ERROR: Invalid signal")\n    else:\n        print(f"Signal decoded: {result}")\n    finally:\n        print("Transmission complete")\n\ndecode_signal("21")',
    testCases: [
        {
            id: 'tc01',
    ...
    hints: [
        { tier: 1, text: 'else: runs when no exception occurred. finally: runs no matter what.' },
        { tier: 2, text: 'The full pattern is: try → except → else → finally.' },
        { tier: 3, text: 'Solution: except ValueError:, else:, finally: as three separate blocks' },
    ],
...
//# sourceMappingURL=ch08_03_try_except_else_finally.js.map