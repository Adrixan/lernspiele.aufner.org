export const ch08_07_graceful_degradation = {
    ...
    hints: [
        { tier: 1, text: 'Use a try/except block to catch KeyError when a key is missing.' },
        { tier: 2, text: 'The default parameter provides a fallback value when the key is not found.' },
        { tier: 3, text: 'Solution: try: return database[key] except KeyError: return default' },
    ],
...
//# sourceMappingURL=ch08_07_graceful_degradation.js.map