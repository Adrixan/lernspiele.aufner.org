export const ch08_06_input_validation_with_errors = {
    ...
    hints: [
        { tier: 1, text: 'Use str.startswith() to check the prefix and len() to check the length.' },
        { tier: 2, text: 'Raise ValueError with a descriptive message for each validation failure.' },
        { tier: 3, text: 'Solution: Check startswith("AGT-") first, then len(agent_id) != 7, raising ValueError each time.' },
    ],
...
//# sourceMappingURL=ch08_06_input_validation_with_errors.js.map