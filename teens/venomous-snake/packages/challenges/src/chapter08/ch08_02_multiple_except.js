export const ch08_02_multiple_except = {
    ...
    hints: [
        { tier: 1, text: 'You can have multiple except blocks to catch different error types.' },
        { tier: 2, text: 'KeyError is raised when accessing a missing dictionary key. TypeError when the type is wrong.' },
        { tier: 3, text: 'Solution: except KeyError: and except TypeError: as separate blocks' },
    ],
...
//# sourceMappingURL=ch08_02_multiple_except.js.map