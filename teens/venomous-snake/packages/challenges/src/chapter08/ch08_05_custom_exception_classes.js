export const ch08_05_custom_exception_classes = {
    ...
    hints: [
        { tier: 1, text: 'Custom exceptions inherit from Exception. Use class MyError(Exception):' },
        { tier: 2, text: 'Call super().__init__(message) to set the error message. Store extra data as attributes.' },
        { tier: 3, text: 'Solution: class MissionError(Exception): with super().__init__(message) and self.mission_id = mission_id' },
    ],
...
//# sourceMappingURL=ch08_05_custom_exception_classes.js.map