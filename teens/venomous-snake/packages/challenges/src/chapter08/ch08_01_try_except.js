export const ch08_01_try_except = {
    ...
    scaffoldedCode: 'def parse_code(code_str):\n    ___:\n        return int(code_str)\n    ___ ValueError:\n        return -1\n\nprint(parse_code("42"))\nprint(parse_code("invalid"))',
    editableRegions: [
        { startLine: 2, endLine: 4, placeholder: 'try / except' },
    ],
    solutionCode: 'def parse_code(code_str):\n    try:\n        return int(code_str)\n    except ValueError:\n        return -1\n\nprint(parse_code("42"))\nprint(parse_code("invalid"))',
    testCases: [
        {
            id: 'tc01',
    ...
    hints: [
        { tier: 1, text: 'Use try: to wrap code that might fail, and except to catch specific errors.' },
        { tier: 2, text: 'except ValueError: catches errors when int() receives a non-numeric string.' },
        { tier: 3, text: 'Solution: try: return int(code_str) except ValueError: return -1' },
    ],
...
//# sourceMappingURL=ch08_01_try_except.js.map