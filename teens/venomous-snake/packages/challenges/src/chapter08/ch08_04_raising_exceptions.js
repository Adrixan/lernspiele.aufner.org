export const ch08_04_raising_exceptions = {
    ...
    hints: [
        { tier: 1, text: 'Use raise ValueError("message") to raise an error with a custom message.' },
        { tier: 2, text: 'The raise keyword creates an exception that can be caught by a try/except block.' },
        { tier: 3, text: 'Solution: raise ValueError(f"Clearance level {level} is out of range")' },
    ],
...
//# sourceMappingURL=ch08_04_raising_exceptions.js.map