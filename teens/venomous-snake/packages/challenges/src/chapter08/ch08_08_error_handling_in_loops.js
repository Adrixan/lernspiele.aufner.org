export const ch08_08_error_handling_in_loops = {
    ...
    scaffoldedCode: '# Process a list of codes, converting to int\n# Use try/except to replace invalid codes with 0\n# codes = ["42", "??", "17", "error", "99"]\n',
    solutionCode: 'codes = ["42", "??", "17", "error", "99"]\nresults = []\nfor code in codes:\n    try:\n        results.append(int(code))\n    except ValueError:\n        results.append(0)\nprint(results)',
    testCases: [
        {
            id: 'tc01',
    ...
    hints: [
        { tier: 1, text: 'Wrap the int() conversion in a try/except inside the loop.' },
        { tier: 2, text: 'When ValueError occurs, append 0 instead of the converted value.' },
        { tier: 3, text: 'Solution: try: results.append(int(code)) except ValueError: results.append(0)' },
    ],
...
//# sourceMappingURL=ch08_08_error_handling_in_loops.js.map