export const ch10_08_class_static_methods = {
    ...
    hints: [
        { tier: 1, text: 'Class variables are shared across all instances. Access with ClassName._count.' },
        { tier: 2, text: 'A regular method can read class variables via the class name. Standalone functions work like static methods.' },
        { tier: 3, text: 'Solution: return Mission._count in get_count, return name.startswith("OP-") in validate_mission_name' },
    ],
...
//# sourceMappingURL=ch10_08_class_static_methods.js.map