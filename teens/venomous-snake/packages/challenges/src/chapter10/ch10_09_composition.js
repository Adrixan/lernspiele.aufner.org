export const ch10_09_composition = {
    ...
    hints: [
        { tier: 1, text: 'Composition means one class contains instances of another. Building has a list of Floors.' },
        { tier: 2, text: 'Floor needs __str__ for display. Building uses self.floors = [] and append().' },
        { tier: 3, text: 'Solution: Building.add_floor appends to self.floors. list_floors prints each floor.' },
    ],
...
//# sourceMappingURL=ch10_09_composition.js.map