export const ch10_05_inheritance = {
    ...
    hints: [
        { tier: 1, text: 'class Agent(Person): makes Agent inherit from Person. super() calls the parent class.' },
        { tier: 2, text: 'super().__init__(name, age) calls Person.__init__. super().introduce() calls Person.introduce.' },
        { tier: 3, text: 'Solution: class Agent(Person):, super().__init__(name, age), base = super().introduce()' },
    ],
...
//# sourceMappingURL=ch10_05_inheritance.js.map