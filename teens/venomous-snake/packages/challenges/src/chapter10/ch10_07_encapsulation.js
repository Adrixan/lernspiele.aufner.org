export const ch10_07_encapsulation = {
    ...
    hints: [
        { tier: 1, text: 'self.__attribute uses name mangling for privacy. Access it via getter/setter methods.' },
        { tier: 2, text: 'get_clearance returns self.__clearance. set_clearance sets self.__clearance = level.' },
        { tier: 3, text: 'Solution: return self.__clearance and self.__clearance = level' },
    ],
...
//# sourceMappingURL=ch10_07_encapsulation.js.map