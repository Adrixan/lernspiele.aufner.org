export const ch10_03_init_constructor = {
    ...
    hints: [
        { tier: 1, text: '__init__ is called automatically when creating an instance. Parameters go after self.' },
        { tier: 2, text: 'Use self.name = name to store the parameter as an instance attribute.' },
        { tier: 3, text: 'Solution: def __init__(self, name, threat_level): self.name = name self.threat_level = threat_level' },
    ],
...
//# sourceMappingURL=ch10_03_init_constructor.js.map