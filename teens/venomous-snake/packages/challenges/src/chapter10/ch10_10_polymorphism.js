export const ch10_10_polymorphism = {
    ...
    hints: [
        { tier: 1, text: 'Polymorphism means different classes share the same method name but have different behavior.' },
        { tier: 2, text: 'Python uses duck typing: if it has patrol(), you can call it. No shared base class needed.' },
        { tier: 3, text: 'Solution: Three classes each with patrol() returning different strings. run_patrol iterates and prints.' },
    ],
...
//# sourceMappingURL=ch10_10_polymorphism.js.map