export const ch10_02_methods = {
    ...
    scaffoldedCode: 'class SecurityBot:\n    def greet(self):\n        return ___\n    \n    def scan(self, target):\n        return ___\n\nbot = SecurityBot()\nprint(bot.greet())\nprint(bot.scan("intruder"))',
    editableRegions: [
    ...
    hints: [
        { tier: 1, text: 'Methods are functions inside a class. The first parameter is always self.' },
        { tier: 2, text: 'Use return to send a value back. Use f-strings for dynamic strings.' },
        { tier: 3, text: 'Solution: return "HALT. Identify yourself." and return f"Scanning {target}... threat detected."' },
    ],
...
//# sourceMappingURL=ch10_02_methods.js.map