export const ch10_06_method_override = {
    ...
    hints: [
        { tier: 1, text: 'Override a method by defining the same method name in the subclass.' },
        { tier: 2, text: 'Use super().alert() to call the parent version. StealthBot completely replaces the behavior.' },
        { tier: 3, text: 'Solution: EliteBot uses super().alert() + extra text. StealthBot returns "..."' },
    ],
...
//# sourceMappingURL=ch10_06_method_override.js.map