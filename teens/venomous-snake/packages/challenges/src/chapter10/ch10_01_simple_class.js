export const ch10_01_simple_class = {
    ...
    hints: [
        { tier: 1, text: 'Class attributes are defined directly in the class body, like variables.' },
        { tier: 2, text: 'Set name = "SENTINEL", threat_level = 5, active = True inside the class.' },
        { tier: 3, text: 'Solution: class SecurityBot: name = "SENTINEL" threat_level = 5 active = True' },
    ],
...
//# sourceMappingURL=ch10_01_simple_class.js.map