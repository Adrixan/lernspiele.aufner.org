export const ch10_04_str_repr = {
    ...
    hints: [
        { tier: 1, text: '__str__ returns a human-readable string. __repr__ returns a developer-friendly string.' },
        { tier: 2, text: '__repr__ should ideally look like a valid constructor call.' },
        { tier: 3, text: 'Solution: __str__ returns f"SecurityBot: {self.name} (Level {self.level})" and __repr__ returns a constructor-style string' },
    ],
...
//# sourceMappingURL=ch10_04_str_repr.js.map