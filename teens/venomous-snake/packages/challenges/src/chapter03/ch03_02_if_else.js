export const ch03_02_if_else = {
    ...
    scaffoldedCode: '# Check if the door is locked and print the status\ndoor_locked = True\nif ___:\n    print("Door is LOCKED")\nelse:\n    print("Door is OPEN")',
    editableRegions: [{ startLine: 3, endLine: 3, placeholder: 'door_locked' }],
    solutionCode: 'door_locked = True\nif door_locked:\n    print("Door is LOCKED")\nelse:\n    print("Door is OPEN")',
    testCases: [
        {
            id: 'tc01',
...
//# sourceMappingURL=ch03_02_if_else.js.map