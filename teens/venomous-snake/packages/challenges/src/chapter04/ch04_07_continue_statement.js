export const ch04_07_continue_statement = {
    ...
    scaffoldedCode: '# Print active cameras, skip disabled ones\ncameras = [1, 2, 3, 4, 5]\ndisabled = [3]\nfor cam in cameras:\n    if cam in disabled:\n        ___\n    print(f"Camera {cam}: ACTIVE")',
    editableRegions: [{ startLine: 6, endLine: 6, placeholder: 'continue' }],
    solutionCode: 'cameras = [1, 2, 3, 4, 5]\ndisabled = [3]\nfor cam in cameras:\n    if cam in disabled:\n        continue\n    print(f"Camera {cam}: ACTIVE")',
    testCases: [
        {
            id: 'tc01',
...
//# sourceMappingURL=ch04_07_continue_statement.js.map