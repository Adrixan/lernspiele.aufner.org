export const ch04_08_nested_loops = {
    ...
    scaffoldedCode: '# Generate all grid coordinates for the floor plan\nrows = ["A", "B", "C"]\ncols = [1, 2, 3]\nfor row in rows:\n    for col in cols:\n        print(f"___")',
    editableRegions: [{ startLine: 6, endLine: 6, placeholder: '{row}{col}' }],
    solutionCode: 'rows = ["A", "B", "C"]\ncols = [1, 2, 3]\nfor row in rows:\n    for col in cols:\n        print(f"{row}{col}")',
    testCases: [
        {
            id: 'tc01',
...
//# sourceMappingURL=ch04_08_nested_loops.js.map