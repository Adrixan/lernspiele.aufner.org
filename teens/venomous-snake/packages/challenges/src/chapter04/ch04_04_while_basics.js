export const ch04_04_while_basics = {
    ...
    scaffoldedCode: '# Countdown to launch using a while loop\ncountdown = 5\nwhile ___:\n    print(countdown)\n    countdown -= 1\nprint("LAUNCH!")',
    editableRegions: [{ startLine: 3, endLine: 3, placeholder: 'countdown > 0' }],
    solutionCode: 'countdown = 5\nwhile countdown > 0:\n    print(countdown)\n    countdown -= 1\nprint("LAUNCH!")',
    testCases: [
        {
            id: 'tc01',
...
//# sourceMappingURL=ch04_04_while_basics.js.map