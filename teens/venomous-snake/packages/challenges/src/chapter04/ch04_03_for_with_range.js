export const ch04_03_for_with_range = {
    ...
    scaffoldedCode: '# Print the guard rotation schedule for hours 1 through 5\nfor hour in ___:\n    print(f"Hour {hour}: Guard on patrol")',
...
//# sourceMappingURL=ch04_03_for_with_range.js.map