export const ch11_08_putting_it_together = {
    ...
    hints: [
        { tier: 1, text: 'Create a Mission class with __init__ and __repr__. Use a default parameter for status.' },
        { tier: 2, text: 'filter_missions uses list comprehension: [m for m in missions if m.priority >= min_priority].' },
        { tier: 3, text: 'Solution: Mission class with name/priority/status, filter with comprehension, print with f-strings' },
    ],
...
//# sourceMappingURL=ch11_08_putting_it_together.js.map