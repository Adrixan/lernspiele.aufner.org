export const ch11_06_constants_enums = {
    ...
    hints: [
        { tier: 1, text: 'Group related constants in a class. Access with ClassName.CONSTANT.' },
        { tier: 2, text: 'Define values: LOW = 1, MEDIUM = 5, HIGH = 8, CRITICAL = 10.' },
        { tier: 3, text: 'Constants are UPPERCASE variables: MAX_AGENTS = 12, DEFAULT_FLOOR = "lobby"' },
    ],
...
//# sourceMappingURL=ch11_06_constants_enums.js.map