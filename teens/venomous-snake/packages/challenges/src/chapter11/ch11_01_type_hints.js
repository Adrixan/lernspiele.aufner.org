export const ch11_01_type_hints = {
    ...
    hints: [
        { tier: 1, text: 'Type hints annotate parameters and return types: def func(x: int) -> str:' },
        { tier: 2, text: 'Use int, float, str as type annotations. -> indicates return type.' },
        { tier: 3, text: 'Solution: def calculate_xp(base: int, multiplier: float) -> int:' },
    ],
...
//# sourceMappingURL=ch11_01_type_hints.js.map