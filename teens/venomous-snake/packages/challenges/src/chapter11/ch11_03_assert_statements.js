export const ch11_03_assert_statements = {
    ...
    hints: [
        { tier: 1, text: 'assert condition, "message" raises AssertionError if condition is False.' },
        { tier: 2, text: 'units > 0 checks positive, total >= 0 checks non-negative.' },
        { tier: 3, text: 'Solution: assert units > 0, "Unit count must be positive"' },
    ],
...
//# sourceMappingURL=ch11_03_assert_statements.js.map