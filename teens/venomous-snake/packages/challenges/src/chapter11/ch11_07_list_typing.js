export const ch11_07_list_typing = {
    ...
    hints: [
        { tier: 1, text: 'List[str] is a list of strings. Dict[str, int] is a dict with str keys and int values.' },
        { tier: 2, text: 'Optional[str] means the function can return str or None.' },
        { tier: 3, text: 'Solution: List[str], Dict[str, int], Optional[str]' },
    ],
...
//# sourceMappingURL=ch11_07_list_typing.js.map