export const ch11_04_writing_simple_tests = {
    ...
    hints: [
        { tier: 1, text: 'Caesar cipher shifts each letter. ABC shifted by 1 becomes BCD.' },
        { tier: 2, text: 'XYZ shifted by 3 wraps around: X->A, Y->B, Z->C.' },
        { tier: 3, text: 'Solution: "BCD", "ABC", "abc" as expected values' },
    ],
...
//# sourceMappingURL=ch11_04_writing_simple_tests.js.map