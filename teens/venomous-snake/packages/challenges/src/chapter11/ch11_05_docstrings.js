export const ch11_05_docstrings = {
    ...
    hints: [
        { tier: 1, text: 'Good documentation describes what a function does, its parameters, and return value.' },
        { tier: 2, text: 'Use comments to document: purpose, args with types, and return type.' },
        { tier: 3, text: 'Fill in descriptions: threat_level is an int (1-10), location is a string, returns a response string.' },
    ],
...
//# sourceMappingURL=ch11_05_docstrings.js.map