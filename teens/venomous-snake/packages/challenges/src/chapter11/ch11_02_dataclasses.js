export const ch11_02_dataclasses = {
    ...
    hints: [
        { tier: 1, text: 'Data containers need __init__ (constructor), __repr__ (display), and __eq__ (comparison) methods.' },
        { tier: 2, text: '__repr__ returns a string showing how to recreate the object. __eq__ compares all fields.' },
        { tier: 3, text: 'Solution: __repr__ returns f"Agent(name=\'...\', ...)", __eq__ compares name, level, and active' },
    ],
...
//# sourceMappingURL=ch11_02_dataclasses.js.map