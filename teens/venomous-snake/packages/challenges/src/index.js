...
import { ch01_04_string_types } from './chapter01/ch01_04_string_types';
import { ch01_05_float_calculations } from './chapter01/ch01_05_float_calculations';
import { ch01_06_string_concatenation } from './chapter01/ch01_06_string_concatenation';
import { ch01_07_multiple_prints } from './chapter01/ch01_07_multiple_prints';
import { ch01_08_comments } from './chapter01/ch01_08_comments';
import { ch02_01_string_methods } from './chapter02/ch02_01_string_methods';
import { ch02_02_string_indexing } from './chapter02/ch02_02_string_indexing';
import { ch02_03_string_slicing } from './chapter02/ch02_03_string_slicing';
import { ch02_04_fstrings_basics } from './chapter02/ch02_04_fstrings_basics';
import { ch02_05_input_basics } from './chapter02/ch02_05_input_basics';
import { ch02_06_type_conversion } from './chapter02/ch02_06_type_conversion';
import { ch02_07_string_formatting } from './chapter02/ch02_07_string_formatting';
import { ch02_08_len_and_string_ops } from './chapter02/ch02_08_len_and_string_ops';
import { ch03_01_simple_if } from './chapter03/ch03_01_simple_if';
import { ch03_02_if_else } from './chapter03/ch03_02_if_else';
import { ch03_03_comparison_operators } from './chapter03/ch03_03_comparison_operators';
import { ch03_04_if_elif_else } from './chapter03/ch03_04_if_elif_else';
import { ch03_05_logical_operators } from './chapter03/ch03_05_logical_operators';
import { ch03_06_nested_if } from './chapter03/ch03_06_nested_if';
import { ch03_07_boolean_variables } from './chapter03/ch03_07_boolean_variables';
import { ch03_08_complex_conditions } from './chapter03/ch03_08_complex_conditions';
import { ch04_01_simple_for_loop } from './chapter04/ch04_01_simple_for_loop';
import { ch04_02_range_basics } from './chapter04/ch04_02_range_basics';
import { ch04_03_for_with_range } from './chapter04/ch04_03_for_with_range';
import { ch04_04_while_basics } from './chapter04/ch04_04_while_basics';
import { ch04_05_while_condition } from './chapter04/ch04_05_while_condition';
import { ch04_06_break_statement } from './chapter04/ch04_06_break_statement';
import { ch04_07_continue_statement } from './chapter04/ch04_07_continue_statement';
import { ch04_08_nested_loops } from './chapter04/ch04_08_nested_loops';
import { ch04_09_loop_accumulator } from './chapter04/ch04_09_loop_accumulator';
import { ch04_10_for_enumerate } from './chapter04/ch04_10_for_enumerate';
import { ch05_01_simple_function } from './chapter05/ch05_01_simple_function';
import { ch05_02_function_return } from './chapter05/ch05_02_function_return';
import { ch05_03_multiple_parameters } from './chapter05/ch05_03_multiple_parameters';
import { ch05_04_default_parameters } from './chapter05/ch05_04_default_parameters';
import { ch05_05_return_multiple } from './chapter05/ch05_05_return_multiple';
import { ch05_06_functions_calling_functions } from './chapter05/ch05_06_functions_calling_functions';
import { ch05_07_scope } from './chapter05/ch05_07_scope';
import { ch05_08_args } from './chapter05/ch05_08_args';
import { ch05_09_kwargs } from './chapter05/ch05_09_kwargs';
import { ch05_10_lambda } from './chapter05/ch05_10_lambda';
import { ch06_01_create_list } from './chapter06/ch06_01_create_list';
import { ch06_02_list_methods } from './chapter06/ch06_02_list_methods';
import { ch06_03_list_slicing } from './chapter06/ch06_03_list_slicing';
import { ch06_04_list_comprehension } from './chapter06/ch06_04_list_comprehension';
import { ch06_05_tuples } from './chapter06/ch06_05_tuples';
import { ch06_06_dictionaries } from './chapter06/ch06_06_dictionaries';
import { ch06_07_dict_methods } from './chapter06/ch06_07_dict_methods';
...
export const challengeMap = {
    ...
    [ch01_04_string_types.id]: ch01_04_string_types,
    [ch01_05_float_calculations.id]: ch01_05_float_calculations,
    [ch01_06_string_concatenation.id]: ch01_06_string_concatenation,
    [ch01_07_multiple_prints.id]: ch01_07_multiple_prints,
    [ch01_08_comments.id]: ch01_08_comments,
    // Chapter 2
    [ch02_01_string_methods.id]: ch02_01_string_methods,
    [ch02_02_string_indexing.id]: ch02_02_string_indexing,
    [ch02_03_string_slicing.id]: ch02_03_string_slicing,
    [ch02_04_fstrings_basics.id]: ch02_04_fstrings_basics,
    [ch02_05_input_basics.id]: ch02_05_input_basics,
    [ch02_06_type_conversion.id]: ch02_06_type_conversion,
    [ch02_07_string_formatting.id]: ch02_07_string_formatting,
    [ch02_08_len_and_string_ops.id]: ch02_08_len_and_string_ops,
    // Chapter 3
    [ch03_01_simple_if.id]: ch03_01_simple_if,
    [ch03_02_if_else.id]: ch03_02_if_else,
    [ch03_03_comparison_operators.id]: ch03_03_comparison_operators,
    [ch03_04_if_elif_else.id]: ch03_04_if_elif_else,
    [ch03_05_logical_operators.id]: ch03_05_logical_operators,
    [ch03_06_nested_if.id]: ch03_06_nested_if,
    [ch03_07_boolean_variables.id]: ch03_07_boolean_variables,
    [ch03_08_complex_conditions.id]: ch03_08_complex_conditions,
    // Chapter 4
    [ch04_01_simple_for_loop.id]: ch04_01_simple_for_loop,
    [ch04_02_range_basics.id]: ch04_02_range_basics,
    [ch04_03_for_with_range.id]: ch04_03_for_with_range,
    [ch04_04_while_basics.id]: ch04_04_while_basics,
    [ch04_05_while_condition.id]: ch04_05_while_condition,
    [ch04_06_break_statement.id]: ch04_06_break_statement,
    [ch04_07_continue_statement.id]: ch04_07_continue_statement,
    [ch04_08_nested_loops.id]: ch04_08_nested_loops,
    [ch04_09_loop_accumulator.id]: ch04_09_loop_accumulator,
    [ch04_10_for_enumerate.id]: ch04_10_for_enumerate,
    // Chapter 5
    [ch05_01_simple_function.id]: ch05_01_simple_function,
    [ch05_02_function_return.id]: ch05_02_function_return,
    [ch05_03_multiple_parameters.id]: ch05_03_multiple_parameters,
    [ch05_04_default_parameters.id]: ch05_04_default_parameters,
    [ch05_05_return_multiple.id]: ch05_05_return_multiple,
    [ch05_06_functions_calling_functions.id]: ch05_06_functions_calling_functions,
    [ch05_07_scope.id]: ch05_07_scope,
    [ch05_08_args.id]: ch05_08_args,
    [ch05_09_kwargs.id]: ch05_09_kwargs,
    [ch05_10_lambda.id]: ch05_10_lambda,
    // Chapter 6
    [ch06_01_create_list.id]: ch06_01_create_list,
    [ch06_02_list_methods.id]: ch06_02_list_methods,
    [ch06_03_list_slicing.id]: ch06_03_list_slicing,
    [ch06_04_list_comprehension.id]: ch06_04_list_comprehension,
    [ch06_05_tuples.id]: ch06_05_tuples,
    [ch06_06_dictionaries.id]: ch06_06_dictionaries,
    [ch06_07_dict_methods.id]: ch06_07_dict_methods,
...
export function getChallengesForChapter(chapterNumber) {
