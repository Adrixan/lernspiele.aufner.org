    ...
    dialog: {
        ...
        npc: {
            guard: {
                ...
                n5: string;
                n6: string;
                n1_choice_bluff_claim: string;
                n_bluff_claim: string;
                n_bluff_choice_back_down: string;
                n_bluff_choice_insist: string;
                n_alert: string;
            };
            silva: {
                speaker: string;
            ...
            kai: {
                speaker: string;
                n1: string;
                n1_choice_systems: string;
                n1_choice_binary: string;
                n1_choice_access: string;
                n2: string;
                n3: string;
                n3_choice_true: string;
                n3_choice_false: string;
                n4: string;
                n5: string;
                n6: string;
                n1_greeting: string;
            ...
            reeves: {
                speaker: string;
                n1: string;
                n1_choice_clearance: string;
                n1_choice_help: string;
                n2: string;
                n3: string;
                n3_choice_insist: string;
                n3_choice_leave: string;
                n4: string;
                n5: string;
                n6: string;
                n1_warning: string;
            ...
            patel: {
                speaker: string;
                n1: string;
                n1_choice_experiments: string;
                n1_choice_loops: string;
                n1_choice_danger: string;
                n2: string;
                n3: string;
                n3_choice_iterate: string;
                n3_choice_shortcut: string;
                n4: string;
                n5: string;
                n6: string;
                n1_greeting: string;
            ...
            labbot: {
                speaker: string;
                n1: string;
                n1_choice_status: string;
                n1_choice_reboot: string;
                n1_choice_ignore: string;
                n2: string;
                n3: string;
                n3_choice_help: string;
                n3_choice_abort: string;
                n4: string;
                n5: string;
                n6: string;
                n1_greeting: string;
            ...
            voss: {
                speaker: string;
                n1: string;
                n1_choice_cameras: string;
                n1_choice_blind_spots: string;
                n1_choice_leave: string;
                n2: string;
                n3: string;
                n3_choice_deny: string;
                n3_choice_challenge: string;
                n4: string;
                n5: string;
                n6: string;
                n1_warning: string;
            ...
            chen: {
                speaker: string;
                n1: string;
                n1_choice_patterns: string;
                n1_choice_doubts: string;
                n1_choice_mission: string;
                n2: string;
                n3: string;
                n3_choice_agree: string;
                n3_choice_dismiss: string;
                n4: string;
                n5: string;
                n6: string;
                n1_greeting: string;
            ...
            okafor: {
                speaker: string;
                n1: string;
                n1_choice_search: string;
                n1_choice_structure: string;
                n1_choice_restricted: string;
                n2: string;
                n3: string;
                n3_choice_keys: string;
                n3_choice_values: string;
                n4: string;
                n5: string;
                n6: string;
                n1_greeting: string;
            ...
            jamie: {
                speaker: string;
                n1: string;
                n1_choice_whats_wrong: string;
                n1_choice_records: string;
                n1_choice_ignore: string;
                n2: string;
                n3: string;
                n3_choice_promise: string;
                n3_choice_report: string;
                n4: string;
                n5: string;
                n6: string;
                n1_greeting: string;
            ...
            diaz: {
                speaker: string;
                n1: string;
                n1_choice_protocol: string;
                n1_choice_channels: string;
                n1_choice_urgent: string;
                n2: string;
                n3: string;
                n3_choice_encrypted: string;
                n3_choice_open: string;
                n4: string;
                n5: string;
                n6: string;
                n1_greeting: string;
            ...
            echo: {
                speaker: string;
                n1: string;
                n1_choice_trust: string;
                n1_choice_suspicious: string;
                n1_choice_info: string;
                n2: string;
                n3: string;
                n3_choice_accept: string;
                n3_choice_refuse: string;
                n4: string;
                n5: string;
                n6: string;
                n1_greeting: string;
            ...
            kim: {
                speaker: string;
                n1: string;
                n1_choice_appointment: string;
                n1_choice_excuse: string;
                n1_choice_direct: string;
                n2: string;
                n3: string;
                n3_choice_persist: string;
                n3_choice_retreat: string;
                n4: string;
                n5: string;
                n6: string;
                n1_greeting: string;
                n3_hint: string;
                n5_followup: string;
                n1_choice_bluff_pass: string;
                n_bluff: string;
                n_bluff_choice_back_off: string;
                n_bluff_choice_insist: string;
                n_alert: string;
            };
            blackwell: {
                speaker: string;
                n1: string;
                n1_choice_business: string;
                n1_choice_bluff: string;
                n1_choice_confront: string;
                n2: string;
                n3: string;
                n3_choice_double_down: string;
                n3_choice_back_off: string;
                n4: string;
                n5: string;
                n6: string;
                n1_greeting: string;
            ...
            kowalski: {
                speaker: string;
                n1: string;
                n1_choice_factory: string;
                n1_choice_modules: string;
                n1_choice_shortcut: string;
                n2: string;
                n3: string;
                n3_choice_imports: string;
                n3_choice_custom: string;
                n4: string;
                n5: string;
                n6: string;
                n1_greeting: string;
            ...
            delta7: {
                speaker: string;
                n1: string;
                n1_choice_inspect: string;
                n1_choice_bypass: string;
                n1_choice_specs: string;
                n2: string;
                n3: string;
                n3_choice_comply: string;
                n3_choice_override: string;
                n4: string;
                n5: string;
                n6: string;
                n1_greeting: string;
            ...
            volkov: {
                speaker: string;
                n1: string;
                n1_choice_research: string;
                n1_choice_objects: string;
                n1_choice_leave: string;
                n2: string;
                n3: string;
                n3_choice_inheritance: string;
                n3_choice_reject: string;
                n4: string;
                n5: string;
                n6: string;
                n1_greeting: string;
                n3_hint: string;
                n5_followup: string;
                n1_choice_demand_access: string;
                n_bluff: string;
                n_bluff_choice_back_off: string;
                n_bluff_choice_force: string;
                n_alert: string;
            };
            aifragment: {
                speaker: string;
                n1: string;
                n1_choice_who: string;
                n1_choice_remember: string;
                n1_choice_help: string;
                n2: string;
                n3: string;
                n3_choice_restore: string;
                n3_choice_let_go: string;
                n4: string;
                n5: string;
                n6: string;
                n1_greeting: string;
            ...
            coreguardian: {
                speaker: string;
                n1: string;
                n1_choice_identify: string;
                n1_choice_challenge: string;
                n1_choice_reason: string;
                n2: string;
                n3: string;
                n3_choice_prove: string;
                n3_choice_retreat: string;
                n4: string;
                n5: string;
                n6: string;
            ...
            sterling: {
                speaker: string;
                n1: string;
                n1_choice_snake: string;
                n1_choice_warn: string;
                n1_choice_pass: string;
                n2: string;
                n3: string;
                n3_choice_ready: string;
                n3_choice_reconsider: string;
                n4: string;
                n5: string;
                n6: string;
                n1_greeting: string;
            ...
            nova: {
                speaker: string;
                n1: string;
                n1_choice_compete: string;
                n1_choice_ally: string;
                n1_choice_dismiss: string;
                n2: string;
                n3: string;
                n3_choice_deal: string;
                n3_choice_solo: string;
                n4: string;
                n5: string;
                n6: string;
                n1_greeting: string;
            ...
            snake: {
                ...
                n1_choice_challenge: string;
                n1_choice_reason: string;
                n1_choice_defy: string;
                n2: string;
                n3: string;
                n3_choice_understand: string;
                n3_choice_refuse: string;
                n4: string;
                n5: string;
                n6: string;
                ...
                n3_hint: string;
                n5_followup: string;
                n1_choice_bluff_challenge: string;
                n_unprepared: string;
            };
        };
        items: {
            id_card: string;
            executive_clearance: string;
            vault_key: string;
            penthouse_invite: string;
            vault_data: string;
        };
        ui: {
