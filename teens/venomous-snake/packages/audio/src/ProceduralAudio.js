...
function createOfflineCtx(durationSeconds, channels = 1) {
...
export class ProceduralAudio {
    ...
    // Core render helper
    // ---------------------------------------------------------------------------
    static async render(key, durationSeconds, setup, channels = 1) {
    ...
    static generateCyberpunkBeat() {
        ...
        return ProceduralAudio.render('cyberpunk_beat', dur, (ctx) => {
            ...
            for (const accentT of [0, 4 * barDur]) {
                const sweepDur = 0.5;
...
//# sourceMappingURL=ProceduralAudio.js.map